const projectDetails = {
    webtool: {
        ...
        stack: [
            ...
            { name: "Twig", icon: "devicon-twig-original" },
    ...
    tuniv: {
        title: "Projet TUNIV",
        context: "Projet scolaire réalisé en équipe. Il s'agissait de reprendre une application existante de gestion de tournois sportifs et d'y apporter des améliorations.",
        description: "J'ai participé à la sécurisation et à l'amélioration d'une application de gestion de tournois sportifs. Mon travail a consisté à renforcer la sécurité de l'application Spring Boot, à optimiser les requêtes PostgreSQL et à améliorer l'interface utilisateur Vue.js.",
        stack: [
        ...
        technical: [
            "Analyse et correction des failles de sécurité existantes.",
            "Optimisation des requêtes PostgreSQL pour améliorer les performances.",
            "Développement de nouvelles fonctionnalités sur l'interface Vue.js.",
    ...
    infirmiere: {
        ...
        context: "Projet scolaire réalisé en équipe. L'objectif était de créer une application permettant aux étudiants de contacter facilement l'infirmière de l'IUT.",
        description: "J'ai développé une application web avec CakePHP permettant aux étudiants de prendre rendez-vous ou de contacter l'infirmière scolaire. Le projet inclut un système de messagerie, une gestion des disponibilités et un espace d'administration.",
        stack: [
        ...
        technical: [
            "Développement du modèle MVC avec CakePHP.",
            "Création de la base de données MariaDB et des requêtes associées.",
